package net.judoboiz.tutorialmod.fluid;
...
public class ModFluids {
    ...
    public static void register() {
        ...
        SOAP_WATER_BUCKET = Registry.register(Registry.ITEM, new Identifier(TutorialMod.MOD_ID, "soap_water_bucket"),
                new BucketItem(ModFluids.STILL_SOAP_WATER, new FabricItemSettings().group(ModItemGroup.MUM).recipeRemainder(Items.BUCKET).maxCount(1)));
    }
}